const questions = [
    ...
    {
        question: "Getting the HTML Id in JS",
        optionA: "document.getElementByName()",
        optionB: "document.getElementByClassName()",
        optionC: "document.getElementById()",
        optionD: "document.getElementByHtmlId()",
        correctOption: "optionC"
    },

    {
        question: "How to add text color in CSS?",
        optionA: "color: red;",
        optionB: "font-color: red;",
        optionC: "text-color: red;",
        optionD: "-webkit-text-color: red;",
        correctOption: "optionA"
    },

    {
        question: "How to add background color in CSS",
        optionA: "bg-color: red;",
        optionB: "color-background: red;",
        optionC: "-webkit-background-color: red;",
        optionD: "background-color: red;",
        correctOption: "optionD"
    },

    {
        question: "Define Footer Tag",
        optionA: "foot",
        optionB: "footer",
        optionC: "feet",
        optionD: "paa",
